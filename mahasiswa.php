...
<div class="card-body">
  ...
  while($data = mysqli_fetch_array($sql)) {
    ...
    <tr>
      ...
      <td>
        <!--Button Edit-->
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalEditMhs<?php echo $no ?>">
      ...
      <!-- Modal Edit -->
      <div class="modal fade" id="ModalEditMhs<?php echo $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="proses/proses_edit_data_mahasiswa.php" method="POST">
      ...
      <!-- Button Delete -->
      <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#ModalDeleteMhs<?php echo $no ?>">
      ...
      <!-- Modal Delete -->
      <div class="modal fade" id="ModalDeleteMhs<?php echo $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="proses/proses_hapus_data_mahasiswa.php" method="POST">
            <div class="modal-body">
            <input type="hidden" name="id_user" value="<?php echo $data['id_user']; ?>">
              Apakah Anda ingin menghapus data <?php echo $data['nama'] . ' ' . $data['nim']?> ?
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
